...
ZONES = {
    1: {"stations": [
        ...
        "хрещатик", "арсенальна",  "героїв дніпра", "мінська", "оболонь", "почайна",
        "тарса шевченка", "контрактова площа", "поштова площа",
        "майдан незалежності", "сирець", "дорогожичі", "лук'янівська", "золоті ворота"
    ]},
    2: {"stations": [
        "палац спорту", "кловська", "печерська", "звіринецька", "видубичі", "площа українських героїв",
